...
- self driving couch
  - Vision stack [here](https://github.com/charliemeyer2000/couch-vision), and we've just built the frame and mounted motors. We can currently teleop the couch with a ps4 controller (see video of my friend will driving it in my apartment), and will be doing self-driving tests on the road soon.
    <video src="/teleop_couch.mp4" controls loop muted playsinline style="max-width: 400px;"></video>
